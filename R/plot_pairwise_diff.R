#' Generate a barplot of all the observed pairwise differences.
#' @export
#' @importFrom dplyr %>%
#' @import plotly
#' @param plot_data a dataframe generated by grups.plots::load_pairwise_file()
#' @param hide_self_comparisons (bool) whether to hide self-comparisons 
#'        from the plot
