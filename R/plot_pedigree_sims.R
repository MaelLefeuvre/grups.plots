#' Plot pair-specific pedigree simulation results, in the form of a set
#' of violin plots vs. the observed pairwise mismatch rate of that pair.
#' @export
#' @importFrom magrittr %>%
#' @importFrom utils read.table
#' @import plotly
#' @import RColorBrewer
#' @param sims_dataframe (dataframe) a dataframe of pair-specific '.sims'
#'        raw simulations results
#' @param results_data (dataframe) a dataframe generated by the function
#'        grups.plots::load_pairwise_file()
#' @param labels_to_plot (list) a list of pedigree comparison labels to
#'        plot.
#' @param pair label of the target pairwise comparison to plot
